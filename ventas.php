...
<head>
  <meta charset="utf-8">
  <title>Mexiquimicos: Ventas</title>
  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#portfolio">Venta de Productos y Materiales</a></li>
          <li><a href="#team">Reporte de Existencia</a></li>
          <li><a href="#contact">Reporte de Ventas</a></li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 content">
            ...
            <ul>
              <li><h4>Visión:</h4>Afianzar nuestro desarrollo y crecimiento junto con colaboradores, clientes y proveedores.</li>
              <li><h4>Misión:</h4>Ofrecer productos de calidad a los mejores precios, siendo éticamente responsables con las necesidades de salud de nuestros clientes, su bienestar y economía personal, dando un servicio con sentido social, respeto al entorno y al ser humano, para que así trascienda nuestra empresa.</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft" data-wow-delay="0.2s">
              ...
              <p class="description">Dinos que necesitas y te enviaremos la cotización. Podrás recogerlo en nuestra tienda o si quieres te lo mandamos a donde estés. Aceptamos tarjetas de crédito, débito, VISA y Mastercard. Puedes pagar con Puntos Bancomer. Para cotización de Productos llena esta forma:</p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight" data-wow-delay="0.2s">
              ...
              <p class="description">Podemos mandar todos nuestros productos incluyendo medicamentos, instrumental, químicos y productos a granel a cualquier parte de la República Mexicana o del mundo, respetando los procedimientos aduanales de cada país. Para pedir cotización de Envíos por favor llena el formulario al final de ésta página.</p>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="box wow fadeInRight" data-wow-delay="0.2s">
    ...
    <section id="clients" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Clientes</h2>
          <p>En Farmacia París desarrollamos el talento de nuestros colaboradores ofreciéndo una capacitación integral. Creemos que su desempeño está estrechamente ligado a su crecimiento personal y profesional. Consideramos el trabajo como una vía de realización del ser humano mediante el cual es posible trascender.</p>
        </div>
    ...
    <section id="portfolio" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Historia</h2>
          <p>Somos una empresa incluyente y socialmente responsable que se distingue por el esfuerzo y compromiso de todos los que aquí laboramos. El servicio al cliente, la salud, la seguridad, así como el cuidado del medio ambiente son nuestra prioridad y responsabilidad.</p>
        </div>
      </div>
